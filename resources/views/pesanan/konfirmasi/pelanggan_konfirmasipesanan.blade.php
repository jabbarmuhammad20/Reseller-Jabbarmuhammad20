	...
	<div class="row">
		<div class="col-md-12 col-sm-12 ">
			<div class="x_panel">
				...
				<div class="x_content">
					<br />
					<form role="form" action="/konfirmasi_store" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						{{csrf_field() }}
						...
						<div class="item form-group{{ $errors->has('pesanan_id') ? ' has-error' : '' }}">
							...
							<div class="col-md-6 col-sm-6 ">
								<input type="integer" id="first-name" name="pesanan_id" value="{{$riwayat_tranksaksi_tabel->id}}" class="form-control " readonly="">
							</div>
						...
						<div class="item form-group{{ $errors->has('pesanan_id') ? ' has-error' : '' }}">
							...
							<div class="col-md-6 col-sm-6 ">
								<input type="text" id="first-name" name="nm_penerima" value="{{$riwayat_tranksaksi_tabel->nm_pengirim}}" class="form-control " readonly="">
							</div>
							<span class="alert-danger">{{ $errors->first('pesanan_id') }}</span>
						</div>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 ">
								<input type="text" id="last-name" name="produk" value="ID Pesanan : {{$riwayat_tranksaksi_tabel->id}}|| Penerima :{{$riwayat_tranksaksi_tabel->nm_pengirim}} || Kode Produk : {{$riwayat_tranksaksi_tabel->k_produk}}|| Nama Produk :  {{$riwayat_tranksaksi_tabel->n_produk}},|| Ukuran {{$riwayat_tranksaksi_tabel->uk_produk}}" class="form-control" readonly="">
							</div>
						</div>
						<div class="item form-group">
							<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Harga</label>
							<div class="col-md-6 col-sm-6 ">
								<input id="middle-name" class="form-control" name="harga" type="text" name="middle-name" value="{{$riwayat_tranksaksi_tabel->jumlah_total}}" readonly="">
							</div>
						</div>
						<div class="item form-group">
							<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Jumlah Pesanan</label>
							<div class="col-md-6 col-sm-6 ">
								<input id="middle-name" class="form-control" name="qty" type="text" value="{{$riwayat_tranksaksi_tabel->stok_m+$riwayat_tranksaksi_tabel->stok_l+$riwayat_tranksaksi_tabel->stok_xl+$riwayat_tranksaksi_tabel->stok_xxl}}" readonly="">
							</div>
						</div>
						<div class="item form-group">
