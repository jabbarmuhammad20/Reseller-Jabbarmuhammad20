				...
				<div class="x_content">
					...
					{{csrf_field() }}
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 ">
								<input id="middle-name" class="form-control" name="harga" type="text" name="middle-name" value="{{$riwayat_tranksaksi_tabel->hrg_produk}}" readonly="">
							</div>
						</div>
						<div class="item form-group">
							<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Jumlah Pesanan</label>
							<div class="col-md-6 col-sm-6 ">
								<input id="middle-name" class="form-control" name="qty" type="text"  value="{{$riwayat_tranksaksi_tabel->j_pesanan}}" readonly="">
							</div>
						</div>
						<div class="item form-group">
