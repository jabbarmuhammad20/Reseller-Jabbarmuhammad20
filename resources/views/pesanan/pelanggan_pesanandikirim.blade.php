            ...
            <table id="historipelanggan" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a target="blank" href="https://api.whatsapp.com/send?phone=6283824430&text=Saya%20{{$pesanan->User->name}}%20ingin%20mengajukan%20pembatalan%20produk%20nama%20penerima%20({{$pesanan->nm_pengirim}}).%20nama%20produk:%20{{$pesanan->n_produk}}." type="button" class="btn btn-warning btn-sm"><i class="fa fa-undo text-white"> Ajukan Pembatalan</a></i>
                  </td>
                </tr>
                @endif
                @endif
