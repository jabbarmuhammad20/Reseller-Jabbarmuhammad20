              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="" type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target=".konfirmasi"><i class="fa fa-check text-white"> Konfirmasi</i></a>
                    @endif
                    @endif

                    @if($pesanan->dikirim=='ya')
                    @if($pesanan->konfirmasi=='ya')
                    <a href="" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target=".terkonfirmasi"><i class="fa fa-check text-white"> Terkonfirmasi</i></a>
                    @endif
                    @endif
                  </td>
                </tr>
...
<div class="modal fade terkonfirmasi" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="modal fade konfirmasi" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-body text-center">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
        ...
        <h3>Informasi !</h3>
        <h6>Pesanan belum terkonfirmasi dan pembayaran belum diproses, <br> cek aplikasi dan lakukan konfirmasi ! </h6>
        <button type="button" class="btn btn-danger" data-dismiss="modal">Tidak</button>
        <a href="#" type="button" class="btn btn-primary">Konfimasi</a>
      </div>
    </div>
  </div>
</div>