      ...
      <table id="historipelanggan" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> <a href="/hapuspesanan/{{$pesanan->id}}" type="button" class="btn btn-danger btn-sm" ><i class="fa fa-trash text-white" onclick="return confirm('Yakin ingin membatalkan pesanan?')"> Batalkan</a></i></td> 
          </tr>
          @endif
          @endforeach
          </tbody>
