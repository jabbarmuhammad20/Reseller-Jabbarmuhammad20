    ...
    <div class="offcanvas-body">
      ...
      <div class="sidenav-profile">
        ...
        <div class="user-info">
          ...
          <p class="available-balance">Saldo<span class="counter">@currency(Auth::user()->saldo)</span></p>
        </div>
      </div>
      <!-- Sidenav Nav-->
      <ul class="sidenav-nav ps-0">
        <li><a href="mprofile"><i class="lni lni-user"></i>My Profile</a></li>
        ...
        <li><a href="/logout"><i class="lni lni-power-switch"></i>Sign Out</a></li>
      </ul>
    </div>
  </div>