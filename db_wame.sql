...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Jan 2021 pada 16.29
...
--
-- Struktur dari tabel `produk_tabel`
--
...
--
-- Dumping data untuk tabel `produk_tabel`
--

INSERT INTO `produk_tabel` (`id`, `kategori`, `user_id`, `k_produk`, `n_produk`, `deskripsi`, `warna`, `stok_m`, `hrg_m`, `stok_l`, `hrg_l`, `stok_xl`, `hrg_xl`, `stok_xxl`, `hrg_xxl`, `upload_produk`, `created_at`, `updated_at`) VALUES
(1, 'jaket', 1, 'JKTPLS0012', 'jaket polos jumper', 'DETAIL PRODUK : - Bahan : switer fleece  DETAIL UKURAN : - M,L : (panjang 65cm, Lingkar dada 110cm) - XL (panjang 70cm, Lingkar dada 112cm) - XXL (panjang 70cm, Lingkar dada 114cm)', 'Abu Tua', 50, 10000, 49, 20000, 50, 30000, 49, 40000, 'File_Produk/lT70digaZmkGxRUkHOdNqT15Xc8XzSThCea1cXlz.png', '2021-01-25 23:43:16', '2021-01-25 23:43:16');

-- --------------------------------------------------------

--
-- Struktur dari tabel `riwayat_tranksaksi_tabel`
--
...
--
-- Dumping data untuk tabel `riwayat_tranksaksi_tabel`
--
...
--
-- Trigger `riwayat_tranksaksi_tabel`
--
DELIMITER $$
...
--
-- Struktur dari tabel `saldo_tabel`
--
...
--
-- Dumping data untuk tabel `saldo_tabel`
--
...
(1, 'jabbarmuhammad', 'admin', '-', 'jabbarmuhammad20@gmail.com', NULL, '$2y$10$8JdNA6Rqvov1cnRWJg4nZOMjF1xEkp7uXi2Lcwzw0/GFvUYvxzt2u', 'Indramayu', '-', '-', '0', '-', '-', '-', NULL, NULL, 'yqlrCYLP4v87Czt2TKp05avPKhbWLPPO4INwcA3Uz4FyIEf91D2eALhFJoIx', NULL, NULL),
...
--
-- Indeks untuk tabel `produk_tabel`
--
ALTER TABLE `produk_tabel`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `riwayat_tranksaksi_tabel`
--
ALTER TABLE `riwayat_tranksaksi_tabel`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `saldo_tabel`
--
...
--
-- AUTO_INCREMENT untuk tabel `produk_tabel`
--
ALTER TABLE `produk_tabel`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `riwayat_tranksaksi_tabel`
--
ALTER TABLE `riwayat_tranksaksi_tabel`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `saldo_tabel`
--
ALTER TABLE `saldo_tabel`
